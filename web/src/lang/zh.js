...
export default {
  ...
  app: {
    ...
    uploadModelTips:' *若该智能体基于大语言模型创建，则上传图片暂时无法进行解析',
    ...
    topDesc:'生成过程中核采样方法概率阈值。取值越大，生成的随机性越高；取值越小，生成的确定性越高',
    frequencyPenalty:'频率惩罚',
    frequencyPenaltyDesc:'用于控制模型已使用字词的重复率。提高此项可以降低模型在输出中重复相同字词的重复度。',
    punishmentExists:'存在惩罚',
    punishmentExistsDesc:'用于控制模型生成时的重复度，提高此项可以降低模型生成的重复度',
    maxTokens:'最大标记',
    maxTokensDesc:'模型回答的tokens的最大长度',
    topP:'多样性',
    topPDesc:'生成过程中核采样方法概率阈值。取值越大，生成的随机性越高；取值越小，生成的确定性越高',
    repeatedPunishment:'重复惩罚',
    repeatedPunishmentDesc:'用于控制模型生成时的重复度，提高此项可以降低模型生成的重复度',
    visualSetting:'视觉设置',
    picNumLimit:'图片上传限制',
