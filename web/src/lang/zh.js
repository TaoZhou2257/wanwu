...
export default {
    ...
    searchConfig: {
        ...
        keyword: '关键词',
        rerank: 'Rerank模型',
        rerankHint: '重排序模型会根据候选文档与用户问题的语义匹配度，对初步检索结果进行重新排序从而进一步提升最终返回结果的相关性和准确性。',
        loading: '模型加载中...',
        topKHint: '用于控制检索阶段返回的最相关的文档片段的数量。这些文档片段将被送入生成模型中，用于 生成最终的回答。',
        max: '最长上下文',
        ...
        weight: '权重设置',
        weightHint: '权重设置功能用于调整不同检索方式的影响力。通过设置权重，可以控制语义相似度和关键词匹配在最终排序中的占比。',
    },
    explore: {
        hint: '提示',
        asideTitle: '历史应用',
