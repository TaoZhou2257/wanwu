...
const docTemplate = `{
    ...
    "paths": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.AssistantIdRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.ResetPasswordByEmail"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.ResetPasswordSendEmailCode"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.KnowledgeGraphReq"
                        }
                    }
                ],
                "responses": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/response.KnowledgeGraphResp"
                                        }
                                    }
                                }
                            ]
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.KnowledgeReportAddReq"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.KnowledgeReportBatchAddReq"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.KnowledgeReportDeleteReq"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.KnowledgeReportGenerateReq"
                        }
                    }
                ],
                "responses": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/response.KnowledgeReportPageResult"
                                        }
                                    }
                                }
                            ]
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.KnowledgeReportUpdateReq"
                        }
                    }
                ],
                "responses": {
        ...
        "/prompt/optimize": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "提示词优化请求参数",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.PromptOptimizeReq"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.UserAvatarUpdate"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "request.KnowledgeReportBatchAddReq": {
            "type": "object",
            "required": [
                "fileUploadId",
                "knowledgeId"
        ...
        "request.KnowledgeReportDeleteReq": {
            "type": "object",
            "required": [
                "contentId",
                "knowledgeId"
        ...
        "request.KnowledgeReportGenerateReq": {
            "type": "object",
            "required": [
                "knowledgeId"
            ],
        ...
        "request.KnowledgeReportUpdateReq": {
            "type": "object",
            "required": [
                "content",
                "contentId",
        ...
        "request.ResetPasswordSendEmailCode": {
            "type": "object",
            "required": [
                "email"
            ],
        ...
        "response.CozeWorkflowModelInfo": {
            ...
            "properties": {
                ...
                "model_ability": {
                    "$ref": "#/definitions/response.CozeWorkflowModelInfoAbility"
                },
                "model_params": {
                    "type": "array",
                    "items": {
        ...
        "response.CozeWorkflowModelInfoAbility": {
            "type": "object",
            "properties": {
                "audio_understanding": {
                    "type": "boolean"
        ...
        "response.DocChildSegmentResp": {
            ...
            "properties": {
                "contentList": {
                    ...
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/response.ChildSegmentInfo"
                    }
                }
            }
        },
        ...
        "response.GetWorkflowTemplateListResp": {
            ...
            "properties": {
                "downloadLink": {
                    "$ref": "#/definitions/response.WorkflowTemplateURL"
                },
                "list": {
                    "type": "array",
                    "items": {
        ...
        "response.KnowledgeGraphResp": {
            ...
            "properties": {
                ...
                "graph": {
                    "description": "知识图谱节点、边",
                    "allOf": [
                        {
                            "$ref": "#/definitions/response.KnowledgeGraphSchema"
                        }
                    ]
                },
                "processingCount": {
        ...
        "response.KnowledgeGraphSchema": {
            ...
            "properties": {
                ...
                "edges": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/response.KnowledgeGraphEdge"
                    }
                },
                "graph": {
                    "$ref": "#/definitions/response.KnowledgeGraphSourceIdList"
                },
                "mutigraph": {
                    "type": "boolean"
                },
                "nodes": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/response.KnowledgeGraphNode"
                    }
                }
            }
        },
        "response.KnowledgeGraphSourceIdList": {
            "type": "object",
            "properties": {
                "source_id": {
                    "type": "array",
        ...
        "response.KnowledgeReportPageResult": {
            "type": "object",
            "properties": {
                "canAddReport": {
                    "description": "是否可新增社区报告：true.可新增 false.不可新增",
                    "type": "boolean"
                },
                "canGenerate": {
                    "description": "是否可生成：true.可生成 false.不可生成",
                    "type": "boolean"
                },
                "createdAt": {
                    "description": "生成时间：unix毫秒级时间戳，若为空串显示-",
                    "type": "string"
                },
                "generateLabel": {
                ...
                "list": {
                    ...
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/response.KnowledgeReportInfo"
                    }
                },
                "pageNo": {
                    "description": "当前页码",
        ...
        "response.StatisticChart": {
            ...
            "properties": {
                "lines": {
                    "description": "统计表中线段集合",
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/response.StatisticChartLine"
                    }
                },
                "tableName": {
                    "description": "统计表名字",
        ...
        "response.StatisticChartLine": {
            ...
            "properties": {
                "items": {
                    ...
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/response.StatisticChartLineItem"
                    }
                },
                "lineName": {
                    "description": "线段名字",
        ...
        "response.StatisticChartLineItem": {
            "type": "object",
            "properties": {
                "key": {
                    "type": "string"
