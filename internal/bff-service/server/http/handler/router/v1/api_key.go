...
func registerAPIKey(apiV1 *gin.RouterGroup) {
	...
	mid.Sub("api_key").Reg(apiV1, "/api/key/update", http.MethodPost, v1.UpdateAPIKey, "更新API密钥")
	mid.Sub("api_key").Reg(apiV1, "/api/key/status", http.MethodPost, v1.UpdateAPIKeyStatus, "更新API密钥状态")
}
